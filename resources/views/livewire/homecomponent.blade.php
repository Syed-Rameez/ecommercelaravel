					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="/shop" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
								<figure><img src="{{asset('assets/images/products/tools_equipment_7.jpg')}}" width="800" height="800alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
							</a>
							<div class="group-flash">
								<span class="flash-item sale-label">sale</span>
							</div>
							<div class="wrap-btn">
								<a href="/shop" class="function-link">quick view</a>
							</div>
						</div>
						<div class="product-info">
							<a href="/shop" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker [White]</span></a>
